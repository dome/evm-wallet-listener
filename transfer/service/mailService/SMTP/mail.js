  ...
  if (!isMailBlocked && CONFIG.NODE_ENV !== 'development') {
    try {
      ...
      const message = {
        ...
        subject: `ICO - Wallet Listener Issue on ${CONFIG.PROJECT_NAME.toUpperCase()}-${CONFIG.NODE_ENV.toUpperCase()}-${CONFIG.BLOCKCHAIN.CHAIN.toUpperCase()} instance - Transfer Coins/Tokens - ${formattedCurrentTime}`,
        text: `Hi, \n\nWallet Listener was unable to send to admin wallet. Please resolve it as soon as possible.\n\n ${error}`,
      };
