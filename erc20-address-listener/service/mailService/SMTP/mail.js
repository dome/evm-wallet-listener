  ...
  if (!isMailBlocked && CONFIG.NODE_ENV !== 'development') {
    try {
      ...
      const message = {
        ...
        subject: `ICO - Wallet Listener Issue on ${CONFIG.PROJECT_NAME.toUpperCase()}-${CONFIG.NODE_ENV.toUpperCase()}-${CONFIG.BLOCKCHAIN.CHAIN.toUpperCase()} instance - ERC20 Address Listener- ${formattedCurrentTime}`,
