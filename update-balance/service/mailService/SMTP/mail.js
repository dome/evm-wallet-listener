  ...
  if (!isMailBlocked && CONFIG.NODE_ENV !== 'development') {
    try {
      ...
      const message = {
        ...
        subject: `ICO - Wallet Listener Issue on ${CONFIG.PROJECT_NAME.toUpperCase()}-${CONFIG.NODE_ENV.toUpperCase()}-${CONFIG.BLOCKCHAIN.CHAIN.toUpperCase()} instance - Update Balance - ${formattedCurrentTime}`,
        text: `Hi, \n\nWallet Listener was unable to communicate with backend. Please resolve it as soon as possible.\n\n ${error}`,
      };
